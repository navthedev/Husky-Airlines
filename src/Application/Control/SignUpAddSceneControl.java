...
public class SignUpAddSceneControl {
	...
	private static TextField fNameT, lNameT, admin_idT, passwordT, confPasswordT, emailT;
	...
	public static void initialize() {
		...
		confPasswordT = SignUpAddScene.getConfPasswordT();
		 emailT = SignUpAddScene.getEmailT();
	}
...
//    }
	...
	public static void handle_okB() {
		if (isInputValid()) {
			...
			AdminData.insertAdmin(admin_idT.getText(), fNameT.getText(), lNameT.getText(), encodedPassword,
